...
models_list = [['yolov8n.pt', 'nano'], ['yolov8s.pt', 'small'], ['yolov8m.pt', 'medium'], ['yolov8l.pt', 'large'], ['yolov8x.pt', 'xlarge']]
            ...
            for img_shp in img_shapes_list:
                ...
                for workers in range(8, 0, -2):
                    if train_done:
                        ...
                        command = f'python3 yolov8_train_imagine_arg.py {dataset} {model[1]} {lr} {img_shp[0]} {img_shp[1]} {workers}'
